...
import dashboard from "../img/dashone.png";
import p1 from "../img/q1.png";
import p2 from "../img/q2.png";
import p3 from "../img/q3.png";
import p4 from "../img/q4.png";
import p5 from "../img/q5.png";
import p6 from "../img/q6.png";
import mob1 from "../img/mob1.png";
import mob2 from "../img/mob3.png";
  ...
  return (
    <>
      ...
      <section className="">
        <div className="container">
          <div className="text-center">
            <p className="desh-tag text-black fw-semibold">
              Shaping the future of{" "}
              <span className="desh-end fw-semibold">
                financial services in
              </span>
            </p>
            <div>
              <p className="tag-desh text-black fw-semibold">
                <span className="end-desh fw-semibold">partnership</span> with
                leading brands
              </p>
            </div>
      ...
      <section className="issue">
        <div className="container">
          <div className="issue-data">
            <div className="row">
              <div className="col-md-6  img-mob-1">
                <img src={mob2} alt="" className="" />
              </div>
              <div className="col-md-6">
                <p className="text-white fs-1 fw-semibold pt-5 img-data">
                  Issue{" "}
          ...
          <div className="efforts-logo">
            <div className="row ">
              <div className="col-md-6 ">
                <p className="fs-1 fw-semibold pt-3 text-white">
              ...
              <div className="pricing">
                <div className="pt-5">
                  <div className="row bg-white issue-unlock rounded-2">
                    <div className="col-md-6">
                      <p className="fs-2">
                        Unlock the{" "}
      ...
      <section className="unlocks">
        <div className="container">
          <div className="simple-step-modify">
